...
<body style="background-color: #f4f4f4; margin: 0 !important; padding: 0 !important;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td bgcolor="#4DE3F3" align="center">
        ...
        <tr>
            <td bgcolor="#4DE3F3" align="center" style="padding: 0px 10px 0px 10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;">
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 20px;" bgcolor="#4DE3F3"><a
                                                        href="#" target="_blank"
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">{{Carbon\Carbon::parse($user->created_at)->format('d/m/Y H:i:s')}}<br>
                                {{$user->email}}</p>
                        </td>
                    </tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#FFC9DD" align="center"
                            ...
                            <p style="margin: 0;"><a href="#" target="_blank" style="color: #4DE3F3;">We&rsquo;re here
                                    to help you out</a></p>
                        </td>
                    </tr>
                </table>
