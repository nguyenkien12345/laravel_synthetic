...
<body style="text-size-adjust: none; background-color: #f5f5f5; margin: 0; padding: 0;">
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="left"
                                                                    style="line-height:10px"><img
                                                                        src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/326/Logo.png"
                                                                        style="height: auto; display: block; border: 0; max-width: 195px; width: 100%;"
                                                                        width="195" alt="Image" title="Image"></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="column column-2" width="50%"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; text-align: left; font-weight: 400; padding-bottom: 25px; padding-right: 25px; padding-top: 25px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                                    <table class="button_block block-1" width="100%" border="0"
                                                        cellpadding="0" cellspacing="0" role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:10px;padding-left:10px;padding-top:10px;text-align:right;">
                                                                <div class="alignment" align="right">
                                                                    <a href="#" target="_blank"
                                                                        style="text-decoration:none;display:inline-block;color:#052d3d;background-color:#e3edfe;border-radius:14px;width:auto;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:5px;padding-bottom:5px;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:14px;text-align:center;mso-border-alt:none;word-break:keep-all;"><span
                                                                            style="padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="word-break:break-word;"><span
                                                                                    ...
                                                                                    data-mce-style>{{$user->email}}</span></span></span></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img class="fullWidth"
                                                                        src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/326/illo_welcome_1.png"
                                                                        style="height: auto; display: block; border: 0; max-width: 540px; width: 100%;"
                                                                        width="540" alt="Image" title="Image"></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:50px;"><strong><span
                                                                                        style="font-size:50px;"><span
                                                                                            style="font-size:38px;">{{$user->phone}}</span></span></strong></span>
                                                                        </p>
                                                                        <p
                                                                    ...
                                                                    <a href="#" target="_blank"
                                                                        style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#fc7318;border-radius:15px;width:auto;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:10px;padding-bottom:10px;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;"><span
                                                                            style="padding-left:40px;padding-right:40px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="word-break: break-word; line-height: 32px;"><strong>{{Carbon\Carbon::parse($user->created_at)->format('d/m/Y
                                                                                    H:i:s')}}</strong></span></span></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <table class="social_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div class="alignment" align="center">
                                                                    <table class="social-table" width="188px" border="0"
                                                                    ...
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:14px;"><a
                                                                                    ...
                                                                                    href="#" target="_blank"
                                                                                    rel="noopener"><strong>Help&
                                                                                        FAQ's</strong></a> |&nbsp;
                                                                                <strong><a
                                                                                        style="text-decoration: none; color: #2190E3;"
                                                                                        href="#" target="_blank"
                                                                                        rel="noopener">Returns</a>&nbsp;</strong>
                                                                                |&nbsp;&nbsp;<span
                                                                                    ...
                                                                                    <td
                                                                                        ...
                                                                                        <a href="https://www.designedwithbee.com/"
                                                                                            ...
                                                                                            style="text-decoration: none;"><img
                                                                                                ...
                                                                                                height="32" width="34"
                                                                                                align="center"
                                                                                                style="height: auto; display: block; margin: 0 auto; border: 0;"></a>
                                                                                    </td>
                                                                                    <td
