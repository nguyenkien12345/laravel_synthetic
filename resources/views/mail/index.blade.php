...
<body style="background-color: #f4f4f4; margin: 0 !important; padding: 0 !important;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <!-- LOGO -->
        <tr>
            <td bgcolor="{{$data['color']}}" align="center">
        ...
        <tr>
            <td bgcolor="{{$data['color']}}" align="center" style="padding: 0px 10px 0px 10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            ...
                            <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Welcome {{$user->name}}!</h1> <img
                                src="https://firebasestorage.googleapis.com/v0/b/mewzik-c3c20.appspot.com/o/staticHtml%2Fsound.png?alt=media&token=e4ffc196-72e0-46be-93bc-a08f45599978"
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">Thank you for choosing Radian. First, you need to confirm your
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 20px;"
                                                    bgcolor="{{$data['color']}}"><a href="#" target="_blank"
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">This is an auto-generated email. Please <b>do not</b> reply to this
                                email.</p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">{{ Carbon\Carbon::parse($user->created_at)->format('d/m/Y H:i:s')
                                }}<br>
                                {{$user->email}}</p>
                        </td>
                    </tr>
        ...
        <tr>
            <td bgcolor="#f4f4f4" align="center" style="padding: 30px 10px 0px 10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#FFC9DD" align="center"
                            ...
                            <p style="margin: 0;"><a href="#" target="_blank"
                                    style="color: {{$data['color']}};">We&rsquo;re here
                                    to help you out</a></p>
                        </td>
                    </tr>
                </table>
